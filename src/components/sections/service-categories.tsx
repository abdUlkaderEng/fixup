         ...
         <div className="container mx-auto px-4">
            <div className="text-center mb-16">
               <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
                  استعراض المهن المتوفرة
               </h2>
               <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  اعثر على العامل المثالي لاحتياجات منزلك
               </p>
            </div>
                  ...
                  >
                     ...
                     <CardHeader className="text-center pb-4 transition-all duration-500">
                        <div className="flex items-center flex-col  justify-center transition-all duration-500">
                           ...
                           >
                              <Wrench className="w-8 h-8 text-white group-hover:w-6 group-hover:h-6 transition-all duration-500" />
                           </div>
                           <CardTitle
