...
export const mapBackendUserToAuthUser = (
   ...
   longitude: backendUser.address?.longitude ?? null,
   detailed_address: backendUser.address?.detailed_address ?? null,
   area_address_id: backendUser.address?.area_address_id ?? null,
